...
class TestDataRepository {
  ...
  static helpContent = {
    ...
    "det-suite1": {
      ...
      steps: "1. Position test vehicle with clean/dirty/damaged plate. 2. Drive at specified speeds. 3. Test day/night with IR. 4. Check Plaza Manager logs for plate data and confidence scores.",
      testData: "UAE plates, foreign plates, damaged plates, obscured plates.",
      instructions: "Clean lens before day tests; use IR illuminators at night.",
      environment: "SIT lane with calibrated ANPR camera.",
      testingType: "Functional (Manual) + Performance (Stress)",
      testingLevel: "Component",
      targetSystem: "API + Device",
      tools: "Postman, Playwright (UI verification), SQL (DB logs)"
    },
    "det-suite2": {
      title: "RFID – Tag Detection",
      steps: "1. Position vehicle at 5m, 10m, 15m from reader. 2. Test with valid, damaged, and missing tags. 3. Verify read success rate.",
      testData: "Valid RFID tags, expired tags, vehicles without tags.",
      instructions: "Ensure antenna alignment; avoid metal obstructions.",
      environment: "SIT lane with RFID reader.",
      testingType: "Functional (Manual) + Performance (Load)",
      testingLevel: "Component",
      targetSystem: "API + Device",
      tools: "Postman, SQL (event logs)"
    },
    "det-suite3": {
      title: "WIM Accuracy",
      steps: "1. Drive certified calibration truck at 5, 10, 20 km/h. 2. Compare recorded weights to certified reference. 3. Test imbalanced load, abrupt braking, overload.",
      testData: "Certified truck with known axle and gross weights.",
      instructions: "Allow sensor stabilization between runs; ensure smooth pavement.",
      environment: "SIT lane with calibrated WIM sensors.",
      testingType: "Database Testing + Functional (E2E)",
      testingLevel: "Integration",
      targetSystem: "Database + API",
      tools: "SQL (weight tables), Postman (API validation)"
    },
    "det-suite4": {
      title: "AVC Dimensions",
      steps: "1. Pass calibration vehicle with certified dimensions. 2. Compare recorded length, height, width to reference. 3. Test various vehicle classes.",
      testData: "Calibration vehicle, 2-axle truck, 5-axle semi, motorcycle.",
      instructions: "Verify laser curtain alignment weekly; clean sensors.",
      environment: "SIT lane with calibrated AVC.",
      testingType: "Database Testing + Functional (Manual)",
      testingLevel: "Component",
      targetSystem: "Database + API",
      tools: "SQL, Postman"
    },
    "det-suite5": {
      title: "Axle Counter",
      steps: "1. Pass vehicles with known axle counts (2, 3, 5 axles). 2. Test reverse movement. 3. Verify no ghost transactions.",
      testData: "2-axle, 3-axle, 5-axle vehicles.",
      instructions: "Check sensor sensitivity; adjust for vehicle speed.",
      environment: "SIT lane with Axle Counter.",
    ...
    "det-suite6": {
      title: "Laser Curtain",
      steps: "1. Pass single vehicle. 2. Pass two vehicles in close succession. 3. Test lane straddling. 4. Test with debris/blockage.",
      testData: "Single vehicle, two vehicles tailgating, motorcycle.",
      instructions: "Ensure laser curtain aligned; no obstructions.",
      environment: "SIT lane with Laser Curtain.",
      testingType: "Functional (Manual) + Integration",
      testingLevel: "Component",
      targetSystem: "Device + API",
      tools: "Postman, SQL"
    },
    "det-suite7": {
      title: "Device Health",
      steps: "1. Monitor device heartbeats. 2. Disconnect Ethernet/power to devices. 3. Verify SNMP alerts and UI status updates.",
      testData: "All lane devices operational.",
      instructions: "Use network emulator; monitor alert timing.",
      environment: "SIT environment with SNMP monitoring.",
      testingType: "Integration + Performance (Endurance)",
      testingLevel: "Integration",
      targetSystem: "All systems",
      tools: "SQL (heartbeat tables), Postman, Grafana K6"
    },
    "det-suite8": {
      title: "Environmental Resilience",
      steps: "1. Simulate power loss, high temperature, rain, dust. 2. Verify sensor behavior and alerting.",
      testData: "Climate chamber, water spray, dust simulation.",
      instructions: "Record ambient conditions; verify data integrity.",
      environment: "SIT lane with environmental controls.",
      testingType: "Functional (Manual) + Performance (Stress)",
      testingLevel: "System",
      targetSystem: "All systems",
      tools: "Postman, SQL (anomaly logs)"
    },
    "det-suite9": {
      title: "Calibration Verification",
      steps: "1. Execute calibration procedures for each device. 2. Verify readings within tolerance. 3. Check calibration logs in database.",
      testData: "Certified test vehicles and weights.",
      instructions: "Document all calibration events; sign off.",
      environment: "SIT lane.",
      testingType: "Database Testing + Functional (Manual)",
      testingLevel: "Component",
      targetSystem: "Database",
      tools: "SQL (calibration logs), manual checks"
    },

    // FUSE STAGE
    "fuse-suite1": {
      title: "Fusion Rules",
      steps: "Use MockServer to inject sensor data. Verify unified record creation; test missing field scenarios.",
      testData: "Mock sensor payloads with various combinations.",
      instructions: "Ensure timestamps synchronized.",
      environment: "Plaza Manager sandbox with MockServer.",
      testingType: "Integration + Database Testing",
      testingLevel: "Integration",
      targetSystem: "API + Database",
      tools: "Postman, SQL, Playwright (UI verification)"
    },
    "fuse-suite2": {
      title: "RFID & ANPR Correlation",
      steps: "Present vehicles with various RFID/plate combinations. Check confidence scores and fallback logic.",
      testData: "Matching and mismatched RFID tags and plates.",
      instructions: "Monitor confidence calculation in real-time.",
      environment: "SIT lane.",
      testingType: "Functional (E2E BDD)",
      testingLevel: "Integration",
      targetSystem: "API + Web App",
      tools: "Playwright, Postman, SQL"
    },
    "fuse-suite3": {
      title: "Axle & WIM Cross-Check",
      steps: "Pass vehicles with known axle counts. Introduce discrepancies via sensor simulation.",
      testData: "Vehicles with 2-6 axles.",
      instructions: "Verify manual validation flag on discrepancy.",
      environment: "SIT lane with all sensors.",
      testingType: "Integration + Database Testing",
      testingLevel: "Integration",
      targetSystem: "API + Database",
      tools: "Postman, SQL"
    ...
    "fuse-suite4": {
      ...
      steps: "Trigger passage. Verify all mandatory fields populated in database.",
      testData: "Standard test vehicle.",
      instructions: "Check DB directly after passage.",
      environment: "SIT lane.",
      testingType: "Database Testing",
      testingLevel: "Component",
      targetSystem: "Database",
    ...
    "fuse-suite5": {
      ...
      steps: "Trigger passages with varying confidence levels. Verify Master vs Manual routing.",
      testData: "Vehicles with high and low confidence scenarios.",
      instructions: "Set confidence threshold to 95%.",
      environment: "SIT lane.",
      testingType: "Functional (E2E BDD)",
      testingLevel: "System",
      targetSystem: "API + Web App",
    ...
    "fuse-suite6": {
      title: "Manual Validation Flagging",
      steps: "Trigger low-confidence transactions. Verify they appear in Manual Validation queue.",
      testData: "Vehicles with obscured plates, missing RFID.",
      instructions: "Monitor queue and escalation timer.",
      environment: "SIT lane + Web App.",
      testingType: "Functional (E2E BDD) + UAT",
      testingLevel: "System",
      targetSystem: "Web App + API",
      tools: "Playwright, Postman"
    },
    "fuse-suite7": {
      title: "Duplicate Prevention",
      steps: "Trigger same vehicle twice within 2 seconds. Check for single transaction.",
      testData: "Standard test vehicle.",
      instructions: "Verify database unique constraint.",
      environment: "SIT lane.",
      testingType: "Database Testing + Integration",
      testingLevel: "Component",
      targetSystem: "Database + API",
      tools: "SQL, Postman"
    },
    "fuse-suite8": {
      ...
      steps: "Disconnect network during transaction. Verify local storage and sync after reconnect.",
      testData: "Multiple test vehicles.",
      instructions: "Wait for full reconnect before verification.",
      environment: "SIT lane with simulated WAN outage.",
      testingType: "Performance (Endurance) + Integration",
      testingLevel: "Integration",
      targetSystem: "API + Database",
      tools: "Postman (simulate outage), SQL"
    },
    "fuse-suite9": {
      title: "Decision Tree",
      steps: "Configure confidence thresholds. Simulate various sensor combinations.",
      testData: "Confidence values from 0% to 100%.",
      instructions: "Document each decision path.",
      environment: "Plaza Manager UI.",
      testingType: "Functional (E2E BDD)",
      testingLevel: "System",
      targetSystem: "Web App + API",
      tools: "Playwright, Postman"
    ...
    "fuse-suite10": {
      title: "Concurrency & Load",
      steps: "Use JMeter to simulate 50 TPM load. Monitor CPU, memory, dropped packets.",
      testData: "50 vehicles/minute payload.",
      instructions: "Run for minimum 1 hour.",
      environment: "JMeter on separate host; Plaza Manager on target.",
      testingType: "Performance (Load, Stress, Spike)",
      testingLevel: "System",
      targetSystem: "API + Database",
      tools: "Grafana K6, JMeter, SQL"
    },

    // VALIDATE STAGE
    "val-suite1": {
      title: "Business Rules – Tolling & Exemption",
      steps: "1. Prepare vehicles with various ANPR/RFID/class/wallet/permit combinations. 2. Send transactions from Plaza Manager. 3. Verify toll deduction or exemption applied per Rules 1-6.",
      testData: "Vehicles with valid/invalid ANPR, RFID, class confidence; wallets with/without balance; active/expired permits.",
      instructions: "Reference Business Rules matrix (Rules 1-6).",
      environment: "Central System SIT with Plaza Manager simulator and mock Tahseel.",
      testingType: "Functional (E2E BDD) + Integration",
      testingLevel: "System",
      targetSystem: "API + Web App",
      tools: "Playwright, Postman, SQL"
    },
    "val-suite2": {
      title: "Business Rules – Manual Review",
      steps: "1. Send transactions with low classification confidence. 2. Verify they appear in manual validation queue. 3. Test operator approval/rejection and escalation timeout.",
      testData: "Transactions with class confidence <95%.",
      instructions: "Set confidence threshold per Central configuration.",
      environment: "Central System SIT with Plaza Manager simulator.",
      testingType: "Functional (E2E BDD)",
      testingLevel: "System",
      targetSystem: "Web App + API",
      tools: "Playwright, Postman"
    ...
    "val-suite3": {
      ...
      steps: "1. Send transactions for unregistered vehicles, no-ID cases, and blacklisted vehicles. 2. Verify violation generation per Rules 10-14.",
      testData: "Vehicles without wallet links; blacklisted plates; vehicles with no identification.",
      instructions: "Ensure SRTA fine calculation API is mocked.",
      environment: "Central System SIT with mock SRTA API.",
      testingType: "Integration + Database Testing",
      testingLevel: "Integration",
      targetSystem: "API + Database",
      tools: "Postman, SQL"
    ...
    "val-suite4": {
      ...
      steps: "1. Test insufficient balance, expired permits, suspended permits, corrupted data, future timestamps. 2. Verify graceful handling.",
      testData: "Wallets with low balance; expired/suspended permits; null confidence values.",
      instructions: "Test each edge case independently.",
      environment: "Central System SIT.",
      testingType: "Functional (Manual) + Security",
      testingLevel: "Component",
      targetSystem: "API",
    ...
    "val-suite5": {
      ...
      steps: "1. Push permits via SRTA API (create, update, revoke). 2. Verify storage and subsequent transaction behavior. 3. Test grace period logic.",
      testData: "New permits, extension updates, revocations; expired permits at Day 13, 14, 15.",
      instructions: "Verify audit logs after each SRTA push.",
      environment: "Central System SIT with mock SRTA permit API.",
      testingType: "Integration + Database Testing",
      testingLevel: "Integration",
      targetSystem: "API + Database",
      tools: "Postman, SQL"
    ...
    "val-suite6": {
      title: "NOC Validation",
      steps: "1. Push NOC data via SRTA API. 2. Push permits requiring NOC references. 3. Test with valid, expired, and missing NOCs.",
      testData: "Valid NOC, expired NOC, non-existent NOC reference.",
      instructions: "Test multi-step approval workflow.",
      environment: "Central System SIT with mock SRTA API.",
    ...
    "val-suite7": {
      title: "Violation Detection & Fine Calculation",
      steps: "1. Trigger each violation type. 2. Verify fine amounts returned by SRTA. 3. Test appeal workflow end-to-end.",
      testData: "Vehicles with no permit, expired permit, overweight (10%, 30%), wrong route, time violation.",
      instructions: "Verify fine accuracy matches SRTA tariff table.",
      environment: "Central System SIT with mock SRTA fine API and Tahseel sandbox.",
      testingType: "Functional (E2E BDD) + Integration",
      testingLevel: "System",
      targetSystem: "API + Web App",
      tools: "Playwright, Postman"
    ...
    "val-suite8": {
      title: "Wallet & Payment Validation",
      steps: "1. Test fee/fine posting to Tahseel. 2. Test success, business errors, system errors, retry logic, idempotency. 3. Test wallet linking and top-up.",
      testData: "Valid wallets, insufficient balance accounts, invalid credentials.",
      instructions: "Monitor retry queue; verify max 10 retries with backoff.",
      environment: "Central System SIT with Tahseel test environment.",
      testingType: "Integration + Performance (Load)",
      testingLevel: "Integration",
      targetSystem: "API + Database",
      tools: "Postman, Grafana K6, SQL"
    },
    "val-suite9": {
      title: "Daily Reconciliation",
      steps: "1. Run reconciliation job. 2. Verify matching, missing, and mismatched fines. 3. Test discrepancy thresholds (≤0.1%).",
      testData: "Full day of posted fines; Tahseel settlement file with injected discrepancies.",
      instructions: "Run reconciliation manually and verify scheduled job execution.",
      environment: "Central System SIT with Tahseel test settlement files.",
      testingType: "Database Testing + Integration",
      testingLevel: "System",
      targetSystem: "Database + API",
      tools: "SQL, Postman"
    ...
    "val-suite10": {
      title: "RBAC & Security",
      steps: "1. Login as each role. 2. Verify access permissions. 3. Test audit trail completeness. 4. Test security controls.",
      testData: "User accounts for each role; login attempts (valid, invalid, brute force).",
      instructions: "Verify 403 responses for unauthorized API calls.",
      environment: "Central System SIT with all roles configured.",
      testingType: "Security (Passive & Active) + UAT",
      testingLevel: "System",
      targetSystem: "Web App + API",
      tools: "OWASP ZAP, Playwright, SQL (audit logs)"
    },
    "val-suite11": {
      title: "Integration Validation",
      steps: "1. Test all integration points: Plaza→Central, Central↔SRTA, Central↔Tahseel. 2. Test retry logic, duplicate prevention, offline recovery.",
      testData: "Transactions, permits, fine requests, payment postings.",
      instructions: "Monitor integration logs for errors; verify health dashboard.",
      environment: "Full SIT environment with all external endpoints.",
      testingType: "Integration + Performance (Endurance)",
      testingLevel: "System",
      targetSystem: "API + Database",
      tools: "Postman, SQL, Grafana K6"
    },
    "val-suite12": {
      title: "Data Integrity",
      steps: "1. Query database for orphans, duplicates, NULLs. 2. Verify cross-system data consistency. 3. Test historical data retrieval.",
      testData: "Production-like data volume across all tables.",
      instructions: "Run Daily QA Checklist queries.",
      environment: "Central System SIT database.",
      testingType: "Database Testing",
      testingLevel: "Component",
      targetSystem: "Database",
      tools: "SQL"
    ...
    "val-suite13": {
      title: "Fee & Exemption Configuration",
      steps: "1. View and verify fee structures. 2. Create exemption rules with various conditions. 3. Set working hours and system parameters.",
      testData: "Fee structures, exemption rules, plaza working hours, parameter scopes.",
      instructions: "Test date validation, dynamic form fields, and scope inheritance.",
      environment: "Central System SIT with full configuration access.",
      testingType: "Functional (Manual) + UAT",
      testingLevel: "System",
      targetSystem: "Web App + API",
      tools: "Playwright, Postman"
    },
    ...
    "act-suite1": {
      ...
      steps: "Use test wallets. Execute deductions. Verify precision.",
      testData: "10 AED balance, fee 5.50 AED.",
      instructions: "Check Tahseel transaction log.",
      environment: "Tahseel sandbox.",
      testingType: "Integration + Performance (Load)",
      testingLevel: "Integration",
      targetSystem: "API + Database",
      tools: "Postman, SQL"
    ...
    "act-suite2": {
      ...
      steps: "Trigger violation. Inspect JSON payload to Gov API.",
      testData: "Violation vehicle data.",
      instructions: "Verify all required fields present.",
      environment: "Government API mock.",
      testingType: "Integration + Security",
      testingLevel: "Integration",
      targetSystem: "API",
      tools: "Postman, OWASP ZAP"
    },
    "act-suite3": {
      title: "Notification",
      steps: "Upload Excel fleet file. Verify SMS/email received.",
      testData: "Excel with 50 vehicles.",
      instructions: "Check spam folder.",
      environment: "Notification gateway test.",
      testingType: "Functional (E2E BDD)",
      testingLevel: "System",
      targetSystem: "Web App + API",
      tools: "Playwright, Postman"
    ...
    "act-suite4": {
      ...
      steps: "Measure latency from lane trigger to deduction log.",
      testData: "Standard test vehicle.",
      instructions: "Warm up system before measurement.",
      environment: "Integrated test environment.",
      testingType: "Performance (Load, Stress, Spike)",
      testingLevel: "System",
      targetSystem: "All systems",
      tools: "Grafana K6, JMeter, Postman"
    }
  };
}
